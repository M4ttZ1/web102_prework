...
const totalRaisedFormatted = GAMES_JSON
  .reduce((acc, game) => acc + game.pledged, 0)
  .toLocaleString();
const totalGames = GAMES_JSON.length;
const summary = `A total of $${totalRaisedFormatted} has been raised for ${totalGames} games. Currently, ${unfundedCount} ${unfundedCount === 1 ? 'game remains' : 'games remain'} unfunded.`;


// create a new DOM element containing the template string and append it to the description container
const statusP = document.createElement("p");
statusP.innerHTML = summary;
descriptionContainer.appendChild(statusP);
/************************************************************************************
